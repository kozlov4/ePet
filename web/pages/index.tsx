            ...
            <div className="flex flex-col max-w-[1342px] mx-auto">
                ...
                <section className="relative mt-40 mx-16">
                    <div className="flex flex-col gap-9 max-w-xl">
                        ...
                        <p className="text-[#3A3A3A] text-xl">
                            ...
                            щеплень, отримуйте нагадування про візити до
                            ветеринара та відкривайте нові можливості догляду —
                            все в одному місці Завантажте «єУлюбленець» і
                            зробіть життя свого улюбленця ще кращим{' '}
                        </p>
                        <img
                            src="./google-play.png"
                            alt=""
                ...
                <section className="my-48">
                    ...
                    <div className="px-6 py-14 bg-[rgba(217,217,217,_0.27)] rounded-2xl">
                        ...
                        <div className="flex justify-between w-full py-4">
                            <p className="text-[13px] text-black">
                                Додати нового улюбленця може лише співробітник
                                ЦНАП. Ви отримаєте паспорт тварини у застосунку
                                після внесення даних працівником.
                            </p>
                            <a href="#" className="w-5 h-5">
                                <ArrowFront />
                            </a>
