...
describe('InputField', () => {
    ...
    it('supports different input types', () => {
        ...
        // Note: type="email" is not strictly role="textbox" in some queries, but here it usually works or we query by placeholder/label
        // Let's query by label to be safe
