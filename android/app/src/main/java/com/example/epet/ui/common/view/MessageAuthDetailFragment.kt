...
class MessageAuthDetailFragment : Fragment() {

    private val args: MessageAuthDetailFragmentArgs by navArgs()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_message_auth_detail, container, false)
    }
